      ...
      <div className="announcements-list">
        {announcements.map((announcement) => (
          <div
            ...
            onClick={() => toggleDescription(announcement._id)} // Toggle description on click
          >
            <div className="announcement-header">
              <div className="announcement-author">
                <img className="announcement-avatar" src={announcement.createdBy.avatar}>
                ...
                <>
                  ...
                  {announcement.event && (
                    <div className="announcement-event">
                      ...
                      <div>
                        <p className="announcement-event-date">
                          {new Date(announcement.event.date).toLocaleString()}
                        </p>
                        <p className="announcement-event-location">{announcement.event.location}</p>
                      </div>
                    </div>
                  )}
